...
[Create job > enrichments > type](/web-search-api/api-reference/jobs/create-job#body-enrichments-items-type).
...
<Note>
  ...
  resolution. To learn more, see the [Company enrichment](/web-search-api/api-reference/jobs/company-enrichment-dto) data model.
</Note>
...
- [Initialize endpoint](/web-search-api/api-reference/jobs/initialize-job)
- [Create job endpoint](/web-search-api/api-reference/jobs/create-job)
