...
| `catchall-create-monitor`     | Create a scheduled event monitor for recurring jobs                |
| `catchall-update-monitor`     | Update an existing event monitor's webhook                         |
| `catchall-start-stop-monitor` | Pause or resume an event monitor                                   |
...
[Jobs](/web-search-api/concepts/jobs) and
...
<AccordionGroup>
  ...
  <Accordion title="Schedules">
    ...
    [Event Monitors](/web-search-api/concepts/event-monitors) feature, which
