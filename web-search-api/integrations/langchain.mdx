...
Automate recurring searches with scheduled execution. Event monitor methods in `CatchAllClient` 
...
For detailed event monitor configuration, scheduling syntax, and webhook setup, see
the [Event Monitors guide](/web-search-api/concepts/event-monitors).
