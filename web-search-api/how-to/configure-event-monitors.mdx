---
title: Configure event monitors
sidebarTitle: Configure event monitors
description: Configure reliable, efficient event monitors and optimize performance.
---

This guide covers best practices for event monitor configuration, webhook
implementation, and performance optimization.

<Tip>
  Encountering issues? See [Troubleshoot
  event monitors](/web-search-api/how-to/troubleshoot-event-monitors) for solutions to common
  problems.
</Tip>
...
<Steps>
  <Step title="Create test event monitor">
  ...
  <Step title="Create production event monitor">
...
<Tip>
  ...
  firing](/web-search-api/how-to/troubleshoot-event-monitors#webhook-not-firing).
</Tip>
...
Update webhook assignments or the record limit for an existing event monitor without
recreating it.
...
- [Event Monitors overview](/web-search-api/concepts/event-monitors)
- [Troubleshoot event monitors](/web-search-api/how-to/troubleshoot-event-monitors)
