...
<Note>
  For event monitors, the system automatically adapts time-based filters for recurring
  execution. See [Configure event monitors](/web-search-api/how-to/configure-event-monitors)
  for event monitor-specific guidance.
</Note>
