...
<AccordionGroup>
  ...
  <Accordion title="Company Monitors" icon="building">
    ...
    <Tip>
      See [Company Monitors](/web-search-api/concepts/company-monitors)
...
<Tabs>
  ...
  <Tab title="Event Monitors">
    | Endpoint                                    |  Method  | Description                          |
    | ------------------------------------------- | -------- | ------------------------------------- |
    | `/catchAll/monitors/create`                 | `POST`   | Create scheduled event monitor        |
    | `/catchAll/monitors/{monitor_id}`           | `PATCH`  | Update event monitor                  |
    | `/catchAll/monitors/{monitor_id}`           | `DELETE` | Delete an event monitor               |
    | `/catchAll/monitors`                        | `GET`    | List all event monitors               |
    | `/catchAll/monitors/{monitor_id}/jobs`      | `GET`    | List jobs for an event monitor        |
    | `/catchAll/monitors/{monitor_id}/status`    | `GET`    | Get event monitor execution history   |
    | `/catchAll/monitors/pull/{monitor_id}`      | `GET`    | Get aggregated event monitor results  |
    | `/catchAll/monitors/{monitor_id}/enable`    | `POST`   | Enable an event monitor               |
    | `/catchAll/monitors/{monitor_id}/disable`   | `POST`   | Disable an event monitor              |
  </Tab>
...
<CardGroup cols={2}>
  ...
  <Card title="Event Monitors" icon="clock" href="/web-search-api/concepts/event-monitors">
  ...
  <Card
    ...
    icon="share"
    href="https://www.postman.com/newscatcherapi/newscatcher-public-workspace/collection/38930966-6f0e594c-52f9-4c97-8d41-abe44a396533"
  >
