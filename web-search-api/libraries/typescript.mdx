...
<Tabs>
  <Tab title="Create event monitor">
    ...
    console.log(`Event monitor created: ${monitor.monitor_id}`);
    ```
  ...
  <Tab title="Update event monitor">
    ...
    console.log(`Event monitor updated: ${updated.status}`);
    ```
  </Tab>
  ...
  <Tab title="Pause/Resume">
    ...
    console.log("Event monitor resumed");
    ```
  </Tab>
  ...
  <Tab title="List event monitors">
    ...
    console.log(`Total event monitors: ${monitors.total_monitors}`);
  ...
  <Tab title="Retrieve results">
    ...
    console.log(`Event monitor executed ${jobs.total_jobs} jobs`);
...
try {
  ...
  console.log(`Event monitor created: ${monitorId}`);
