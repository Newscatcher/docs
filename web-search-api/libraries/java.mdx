...
<Tabs>
  <Tab title="Create event monitor">
    Create an event monitor from a completed job:
    ...
    System.out.println("Event monitor created: " + monitor.getMonitorId().orElse("N/A"));
    ```

    <Note>
      Event monitors require a minimum 24-hour interval between executions. Learn more in the
      [Event Monitors documentation](/web-search-api/concepts/event-monitors).
    </Note>
  </Tab>

  <Tab title="Update event monitor">
    Update webhook configuration for an existing event monitor:
    ...
    System.out.println("Event monitor updated: " + updated.getStatus());
    ```
  </Tab>

  <Tab title="Pause/Resume">
    Control event monitor execution:
    ...
    System.out.println("Event monitor paused");

    // Resume event monitor
    client.monitors().enableMonitor(monitorId);
    System.out.println("Event monitor resumed");
    ```
  </Tab>

  <Tab title="List event monitors">
    Retrieve all event monitors for your account:
    ...
    System.out.println("Total event monitors: " + monitors.getTotalMonitors());
  ...
  <Tab title="Retrieve results">
    Access aggregated results from all event monitor executions:
    ...
    System.out.println("Event monitor executed " + jobs.getTotalJobs() + " jobs");
...
<Accordion title="Complete event monitor example">
```java
import com.newscatcher.catchall.CatchAllApi;
import com.newscatcher.catchall.resources.monitors.requests.CreateMonitorRequestDto;
import com.newscatcher.catchall.resources.monitors.requests.UpdateMonitorRequestDto;
...
public class MonitorExample {
    public static void main(String[] args) {
        ...
        try {
            // Create event monitor from completed job
            ...
            String monitorId = monitor.getMonitorId().orElseThrow();
            System.out.println("Event monitor created: " + monitorId);
            ...
            System.out.println("\nEvent monitor executed " + jobs.getTotalJobs() + " jobs");
...
Company monitors let you track specific companies across jobs. Create entities,
...
<Tip>
  ...
  JSON API path, see [Company Monitors](/web-search-api/concepts/company-monitors).
</Tip>
