...
<Tabs>
  <Tab title="Create event monitor">
    ...
    print(f"Event monitor created: {monitor.monitor_id}")
    ```
  ...
  <Tab title="Update event monitor">
    ...
    print(f"Event monitor updated: {updated.status}")
    ```
  </Tab>
  ...
  <Tab title="List event monitors">
    ...
    print(f"Total event monitors: {monitors.total_monitors}")
  ...
  <Tab title="Retrieve results">
    ...
    print(f"Event monitor executed {jobs.total_jobs} jobs")
...
try:
    ...
    monitor_id = monitor.monitor_id
    print(f"Event monitor created: {monitor_id}")
    ...
    print(f"\nEvent monitor executed {jobs.total_jobs} jobs")
